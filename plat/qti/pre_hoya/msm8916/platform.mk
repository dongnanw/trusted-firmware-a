...
PLAT_BL_COMMON_SOURCES	:=	${GICV2_SOURCES}				\
				...
				plat/qti/pre_hoya/msm8916/msm8916_gicv2.c		\
				plat/qti/pre_hoya/msm8916/msm8916_setup.c		\
				plat/qti/pre_hoya/msm8916/${ARCH}/msm8916_helpers.S	\
				plat/qti/pre_hoya/msm8916/${ARCH}/uartdm_console.S
...
MSM8916_PM_SOURCES	:=	drivers/arm/cci/cci.c				\
				...
				plat/qti/pre_hoya/msm8916/msm8916_config.c		\
				plat/qti/pre_hoya/msm8916/msm8916_cpu_boot.c		\
				plat/qti/pre_hoya/msm8916/msm8916_pm.c			\
				plat/qti/pre_hoya/msm8916/msm8916_topology.c

BL31_SOURCES		+=	${MSM8916_PM_SOURCES}				\
				plat/qti/pre_hoya/msm8916/msm8916_bl31_setup.c

PLAT_INCLUDES		:=	-Iplat/qti/pre_hoya/msm8916/include
