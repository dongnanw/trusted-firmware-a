...
PLAT_BL_COMMON_SOURCES	:=	${GICV2_SOURCES}				\
				...
				plat/qti/hoya/msm8916/msm8916_gicv2.c		\
				plat/qti/hoya/msm8916/msm8916_setup.c		\
				plat/qti/hoya/msm8916/${ARCH}/msm8916_helpers.S	\
				plat/qti/hoya/msm8916/${ARCH}/uartdm_console.S
...
MSM8916_PM_SOURCES	:=	drivers/arm/cci/cci.c				\
				...
				plat/qti/hoya/msm8916/msm8916_config.c		\
				plat/qti/hoya/msm8916/msm8916_cpu_boot.c		\
				plat/qti/hoya/msm8916/msm8916_pm.c			\
				plat/qti/hoya/msm8916/msm8916_topology.c

BL31_SOURCES		+=	${MSM8916_PM_SOURCES}				\
				plat/qti/hoya/msm8916/msm8916_bl31_setup.c

PLAT_INCLUDES		:=	-Iplat/qti/hoya/msm8916/include
